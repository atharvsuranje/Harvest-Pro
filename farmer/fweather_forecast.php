...
// Define the API key
$apiKey = "7b1dab298e3b53716a2bd31063c3364f"; // Store API key in a variable
$cityId = $city_weather_id;

// https://api.openweathermap.org/data/2.5/forecast?id=1275339&lang=en&units=metric&APPID=7b1dab298e3b53716a2bd31063c3364f;
...
<script>window.myWidgetParam ? window.myWidgetParam : window.myWidgetParam = [];  window.myWidgetParam.push({id: 9,cityid: '<?php echo $cityId ?>',appid: '<?php echo $apiKey ?>',units: 'metric',containerid: 'openweathermap-widget-9',  });  (function() {var script = document.createElement('script');script.async = true;script.charset = "utf-8";script.src = "//openweathermap.org/themes/openweathermap/assets/vendor/owm/js/weather-widget-generator.js";var s = document.getElementsByTagName('script')[0];s.parentNode.insertBefore(script, s);  })();</script>
