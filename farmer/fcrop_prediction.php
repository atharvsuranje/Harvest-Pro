                ...
                <div class="card text-white bg-gradient-success mb-3">
                    ...
                    <h4>
                        ...
                        if(isset($_POST['Crop_Predict'])){
                            ...
                            // Convert PHP variables to JSON format
                            $JsonState = json_encode($state);
                            $JsonDistrict = json_encode($district);
                            $JsonSeason = json_encode($season);
                            
                            // Execute the Python script
                            $command = escapeshellcmd("python C:/xampp/htdocs/HarvestPro/farmer/ML/crop_prediction/ZDecision_Tree_Model_Call.py $JsonState $JsonDistrict $JsonSeason");
