...
<head>
  <!-- Add jQuery CDN before your custom JS -->
          ...
          <div class="card mb-3">
            <div class="card-body bg-gradient-success">
              <div class="row mb-1">
                ...
                <div class="col-sm-9 text-dark"><?php echo $para1 ?></div>
              </div>
              ...
              <div class="row mb-1">
                ...
                <div class="col-sm-9 text-dark"><?php echo $para2 ?></div>
              </div>
              ...
              <div class="row mb-1">
                ...
                <div class="col-sm-9 text-dark"><?php echo $para5 ?></div>
              </div>
              ...
              <div class="row mb-1">
                ...
                <div class="col-sm-9 text-dark"><?php echo $para6 ?></div>
              </div>
              ...
              <div class="row mb-1">
                ...
                <div class="col-sm-9 text-dark"><?php echo $para7 ?></div>
              </div>
              ...
              <div class="row mb-1">
                ...
                <div class="col-sm-9 text-dark"><?php echo $para8 ?></div>
              </div>
              ...
              <div class="row mb-1">
                ...
                <div class="col-sm-9 text-dark"><?php echo $para9 ?></div>
              </div>
              ...
              <div class="row mb-1">
                ...
                <div class="col-sm-9 text-dark"><?php echo $para10 ?></div>
              </div>
              ...
              <div class="row mb-1">
                ...
                <div class="col-sm-9 text-dark"><?php echo $para11 ?></div>
              </div>
